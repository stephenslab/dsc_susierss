...
DSC:
  define:
    ...
    method_finemapv4: finemapv4, finemapv4L5
  run:
    ...
    pve_n: small_data * sim_gaussian_pve_n * get_sumstats_n * adjustld_n_lamb0 * ((susie_rss_n, susie_rss_Ltrue_n) * score_susie, (finemapv4_n, finemapv4L5_n) * score_finemapv4, caviar * score_caviar, dap_z * score_dap)
  exec_path: code
  global:
