...
res_susierssnull = list('susie_suff_initnull' = res_susierssnull$susie_suff_ERTRUE_ldin_AZFALSE_rcorFALSE)
res_susierssnull$susie_suff_initnull$avgr2 = NULL
res_fm = readRDS('../susierss_ukb_20210218_REF1000_pve005/susierss_ukb_20210218_REF1000_pve005_cs/finemapv4_ukb_cs.rds')
res_fm = list('FINEMAPv1.4' = res_fm$finemapv4_ldin_AZFALSE_pure, 
              'FINEMAPv1.4L4' = res_fm$finemapv4L4_ldin_AZFALSE_pure)
res_fm$FINEMAPv1.4$avgr2 = NULL
res_fm$FINEMAPv1.4L4$avgr2 = NULL
...
rates$method = factor(rates$method, levels = c('susie_initnull', 'susie_initoracle',
                                               ...
                                               'susie_suff_3steps','FINEMAPv1.4','FINEMAPv1.4L4'))
rates_s = rates[c(1:3,8:9),]
