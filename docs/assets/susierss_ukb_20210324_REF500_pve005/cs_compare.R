...
output_susierss = 'susierss_ukb_20210324_REF500_pve005_cs/susierss_ukb_cs'
output_fm = 'susierss_ukb_20210324_REF500_pve005_cs/finemapv4_ukb_cs'
...
output = 'susierss_ukb_20210324_REF500_pve005_cs/ukb_cs_refine'
...
output = 'susierss_ukb_20210324_REF500_pve005_cs/ukb_cs_original'
pdf(paste0(output, '_plots.pdf'), width=12, height=3)
grid.arrange(p1,p2,p3,p4, ncol=4, widths=c(3,3,3,3))
dev.off()
system(paste0("convert -flatten -density 120 ", paste0(output, '_plots.pdf'), " ", paste0(output, '_plots.png')))
