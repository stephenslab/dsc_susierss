...
input_susie = 'susierss_ukb_20210324_REF500_pve005_susie.rds'
input_fmv1 = 'susierss_ukb_20210324_REF500_pve005_fmv1.rds'
input_fmv4 = 'susierss_ukb_20210324_REF500_pve005_fmv4.rds'
# input_caviar = 'susierss_ukb_20210324_REF500_pve005_caviar.rds'
...
dat_susie$adjustld_med.ldmethod[dat_susie$adjustld_med.ldmethod == 'refin_sample'] = 'refin'
...
dat_fmv1$adjustld_med.ldmethod[dat_fmv1$adjustld_med.ldmethod == 'refin_sample'] = 'refin'
...
dat_fmv4 = dat_fmv4 %>% filter(!is.na(method_finemapv4))
...
dat_fmv4$adjustld_med.ldmethod[dat_fmv4$adjustld_med.ldmethod == 'refin_sample'] = 'refin'
...
# dat_caviar$adjustld_med.ldmethod[dat_caviar$adjustld_med.ldmethod == 'refin_sample'] = 'refin'
...
saveRDS(list(susie = dat_susie,fmv1 = dat_fmv1,fmv4 = dat_fmv4),
        'susierss_ukb_20210324_REF500_pve005.2.rds')
