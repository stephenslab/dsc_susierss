...
input = 'susierss_ukb_20210324_REF1000_pve005_pip_extraction/ukb_pip.rds'
output = 'susierss_ukb_20210324_REF1000_pve005_pip_calibration/ukb_pip_calib'
...
## caviar
print('caviar')
methods = c('CAVIAR_ldin_AZFALSE_lamb0',
