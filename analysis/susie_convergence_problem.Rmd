...
The correlation between CS1 (SNP 236), CS3 (SNP 233) and the missed causal SNP 234 is
```{r}
d1$ld[c(233, 234, 236), c(233, 234, 236)]
```

```{r, eval=FALSE}
susie_plot_iteration(f1, L=3, 'output/susie_convergence_problem_d1_f1', pos=c(233, 234, 236, 287, 291))
```
...
![PIP plot at each iteration](output/susie_convergence_problem_d1_f1.gif)
...
```{r, eval=FALSE}
susie_plot_iteration(f2, L=2, 'output/susie_convergence_problem_d1_f2', pos=c(233, 234, 236, 287, 291))
```
![PIP plot at each iteration](output/susie_convergence_problem_d1_f2.gif)
...
```
Using L = 10, the susie model gives 3 CSs. (I used susie_suff_stat, which gives the same result as susie.)
```{r}
...
```{r, eval=FALSE}
susie_plot_iteration(f3, L=10, 'output/susie_convergence_problem_d2_f3', pos=c(222, idx))
```
![PIP plot at each iteration](output/susie_convergence_problem_d2_f3.gif)
